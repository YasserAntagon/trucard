...
var ExternalDropping = /** @class */ (function (_super) {
    ...
    */
    ...
    ExternalDropping.prototype.listenToExternalDrag = function (el, ev, ui) {
        ...
        // listener that tracks mouse movement over date-noded pixel regions
    ...
    // Given a hit to be dropped upon, and misc data noded with the jqui drag (guaranteed to be a plain object),
...
var DayGridHelperRenderer = /** @class */ (function (_super) {
    ...
    // Renders a mock "helper" event. `sourceSeg` is the noded internal segment object. It can be null.
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        var helperNodes = [];
        var rowStructs;
        // TODO: not good to call eventRenderer this way
        rowStructs = this.eventRenderer.renderSegRows(segs);
        // inject each new event skeleton into each noded row
