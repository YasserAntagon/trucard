function initMap(building,street,locality,city,state) {
  ...
  // var building = document.getElementById('txtappa').value;
  // var locality = document.getElementById('txtlandmark').value;
  // var city = document.getElementById('txtcity').value;
  // var state = document.getElementById('txtstate').value;
  // var street = document.getElementById('txtstreet').value;
  /*
      var building = "Shop No 15";
      var locality = "Katepuram";
      var city = "Pune";
      var state = "Maharashtra";
      var street = "Pimple Gurav";*/
  ...
  geocoder.geocode({ 'address': address }, function (results, status) {
    if (status === 'OK') {
      ...
      WarnMsg("Entity System", 'Geocode was not successful for the following reason: ' + status);
      return false;
    }
  });
}
...
function setMarkers(marker, map, loc) {
  ...
  var content = '<div id="iw-container">' +
    '<div class="iw-title"><i class="fa fa-user"></i> Entity Contact Location</div>' +
