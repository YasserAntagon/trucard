...
module.exports.calculateRate = function (Gen, grossamount, transactiontype, clienttrasactionCharges) {
    ...
    // console.log((transactiontype === "redeemCash" || transactiontype === "sellCash" || transactiontype === "sell" || transactiontype === "redeem"))
    if (transactiontype === "redeemCash" || transactiontype === "sellCash" || transactiontype === "sell" || transactiontype === "redeem") {
