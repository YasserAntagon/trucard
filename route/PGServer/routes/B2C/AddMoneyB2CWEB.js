...
router.post('/addb2cWebMoney', function (req, res, next) {
  var cc = req.body;
  ...
  try {
    ...
    cc.responseURL = originURL + cc.responseURL;
      ...
      res.render('b2cWEBresponse', {
        ...
        buybulDB.submitaddmoneyTransLog(json, function (err, response) {
          if (response.status == "200") {
            ...
            var encryptText = "addMoney" + "~" + cc.CRNNo + "~" + "consumer" + "~" + "B2CWEB" + "~" + cc.responseURL;
