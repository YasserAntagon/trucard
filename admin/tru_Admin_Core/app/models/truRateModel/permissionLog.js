var mongoose = require('mongoose'),
    ...
    strenum = { type: String, enum: ["deny", "allow", "comingsoon", "maintenance", "closed", "disable"] }, //on web / mobility 
    //pgstrenum = { type: String, required: true, enum: ["deny", "allow", "comingsoon", "maintenance",  "atom", "closed", "disable"], default: "allow" }, //pg flags // on web / mobility 
    // bool = {type :Boolean,required : true },
    deci = { type: Schema.Types.Decimal128 }, 
    date = { type: Date },
    digistrm = { type: String, enum: ["deny", "allow", "disable"] };
