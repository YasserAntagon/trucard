var mongoose = require('mongoose'),
    ...
    strenum = { type: String, required: true, enum: ["hide", "allow", "comingsoon", "maintenance", "closed", "disable"], default: "allow" }, //on web / mobility 
    //pgstrenum = { type: String, required: true, enum: ["hide", "allow", "comingsoon", "maintenance",  "atom", "closed", "disabled"], default: "allow" }, //pg flags // on web / mobility 
    bool = {type :Boolean },
    deci = { type: Schema.Types.Decimal128 }, 
    date = { type: Date },
    digistrm = { type: String, required: true, enum: ["hide", "allow", "disable"], default: "allow" };
